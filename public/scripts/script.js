...
function addFilmToToWatch(){
  ...
  if(filmsSelect.options.length <= 0){
    ...
    $.post('/search', {id:film.dataset.id, title:film.dataset.title, year: film.dataset.year, poster_path: film.dataset.poster_path, watched:'false', to_watch:'true', backdrop_path:film.dataset.backdrop_path, overview:film.dataset.overview, favourite:false}, function(data, status, xhr){
...
function addFilmToWatched(){
  ...
  if(filmsSelect.options.length <= 0){
    ...
    let film = filmsSelect.options[films.selectedIndex];
    $.post('/search', {id:film.dataset.id, title:film.dataset.title, year: film.dataset.year, poster_path: film.dataset.poster_path, watched:'true', to_watch:'false', backdrop_path:film.dataset.backdrop_path, overview:film.dataset.overview, favourite:false}, function(data, status, xhr){
...
function addFavouriteFilm(){
  ...
  if(filmsSelect.options.length <= 0){
    ...
    let film = filmsSelect.options[films.selectedIndex];
    $.post('/search', {id:film.dataset.id, title:film.dataset.title, year: film.dataset.year, poster_path: film.dataset.poster_path, watched:'true', to_watch:'false', backdrop_path:film.dataset.backdrop_path, overview:film.dataset.overview, favourite:true}, function(data, status, xhr){
